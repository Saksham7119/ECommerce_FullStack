    ...
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      <div className="flex flex-col mb-12">
        <h1 className="text-4xl font-bold text-gray-900 flex items-center gap-3">
          <MdShoppingCart size={36} className="text-gray-900" /> My Cart
        </h1>
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
        ...
        <div className="flex text-sm gap-1 flex-col">
          ...
          <Link className="w-full flex justify-end" to="/checkout">
            <button className="font-semibold w-[300px] py-5 px-4 rounded-lg bg-custom-gradient text-white flex items-center justify-center gap-2 hover:text-gray-300 transition duration-500">
              <MdShoppingCart size={20} /> Checkout
            </button>
          </Link>

          <Link
            className="flex gap-2 items-center mt-2 text-slate-50"
            to="/products"
          >
            <MdArrowBack className="text-slate-500  " />
