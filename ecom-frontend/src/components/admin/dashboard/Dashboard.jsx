...
const Dashboard = () => {
  ...
  return (
    <div>
      <div className="flex md:flex-row mt-8 flex-col lg:justify-between border border-slate-400 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 shadow-lg">
        <DashboardOverview
