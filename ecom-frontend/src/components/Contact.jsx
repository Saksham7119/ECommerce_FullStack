        ...
        <div
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
                ...
                <form className="space-y-4">
                    ...
                    <button className="w-full bg-slate-800 text-white py-2 rounded-lg hover:bg-slate-400 transition duration-300">
                        Send Message
                    </button>
                </form>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            <FaPhone className="text-slate-800 mr-2"/>
                            <span className="text-gray-600">+4 8961 944 149</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-slate-800 mr-2"/>
                            <span className="text-gray-600">saksham.bajpai.work@gmail.com</span>
                        </div>

                        <div className="flex items-center">
                            <FaMapMarkedAlt className="text-slate-800 mr-2"/>
