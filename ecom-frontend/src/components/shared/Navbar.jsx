...
import { FaShoppingCart, FaSignInAlt, FaStore, FaUser } from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0 pt-2">
